    ...
    return (
        ...
        <Link href={`/${name}`} data-region={`${region}`} className={styles.card}>
                ...
                <div>
                    ...
                    <p className={styles.value}>Population: <span className={styles.info}>{population}</span></p>
                    <p className={styles.value}>Region: <span className={styles.info}>{region}</span></p>
                    <p className={styles.value}>Capital: <span className={styles.info}>{capital}</span></p>
                </div>
        </Link>
        </>
    )
